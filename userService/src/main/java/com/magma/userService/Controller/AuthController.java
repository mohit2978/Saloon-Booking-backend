...
import com.magma.userService.Payload.Request.LoginDto;
import com.magma.userService.Payload.Response.ApiResponse;
import com.magma.userService.Payload.Response.ApiResponseBody;
import com.magma.userService.Payload.Response.AuthResponse;
import com.magma.userService.Service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse> HomeControllerHandler() {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(new ApiResponse("welcome to salon app user api"));
    }
    ...
    public ResponseEntity<ApiResponseBody<AuthResponse>> getAccessTokenHandler(
        ...
        return ResponseEntity.ok(new ApiResponseBody<>(true, "refresh token received successfully", response));
    }
