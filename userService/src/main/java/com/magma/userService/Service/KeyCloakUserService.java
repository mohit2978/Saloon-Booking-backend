...
import com.magma.userService.Payload.DTO.KeycloakRole;
import com.magma.userService.Payload.DTO.KeycloakUserDTO;
import com.magma.userService.Payload.DTO.KeycloakUserinfo;
import com.magma.userService.Payload.DTO.SignupDto;
import com.magma.userService.Payload.Request.Credential;
import com.magma.userService.Payload.Request.UserRequest;
import com.magma.userService.Payload.Response.TokenResponse;
...
public class KeyCloakUserService {
    ...
    private static final String CLIENT_SECRET = "UTVLD7LAM9UlJNiOHeyDAuGCaf9qQHCJ";
    ...
    private static  final String clientId = "862b476d-6b41-43e9-8332-f2338bd83185";
    ...
    public TokenResponse getAdminAccessToken(String username,
        ...
        try {
            ResponseEntity<TokenResponse> response = restTemplate.exchange(TOKEN_URL,
    ...
    public KeycloakRole getRoleByName(String clientId, String token, String role) throws Exception {
        ...
        try {
            ...
            ResponseEntity<KeycloakRole> response = restTemplate.exchange(url, HttpMethod.GET, requestEntity,
                    KeycloakRole.class, clientId, role
            );
            return response.getBody();
        } catch (Exception e) {
    ...
    public void assignRoleToUser(String userId, String clientId,
                                 List<KeycloakRole> roles, String token) throws Exception {
